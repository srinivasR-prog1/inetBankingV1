...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setDocumentTitle("InetBankingV1 Automation Test Project");
	...
	public void onTestFailure(ITestResult tr) {		
		...
		try {
			...
			extentTest.addScreenCaptureFromPath(BaseClass.captureScreenShotRobo(tr.getName()));
